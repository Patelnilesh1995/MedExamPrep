...
import { BlogDetail, Course, Courses } from "../../Components/keys";
...
const YourBlogDetails = ({ navigation }) => {
    ...
    const formattedDate = formatDate(item.created_at, 'MMM DD YYYY');
    ...
    const renderPackageItem = ({ item }) => (
        <View style={styles.packageItem}>
            ...
            <TouchableOpacity style={{ backgroundColor: Colors.primary, flex: 1, height: 40, justifyContent: 'center' }} onPress={() => handleBuyNow(item)} >
        ...
        <SafeAreaView style={[ConstantStyle.container, { backgroundColor: Colors.primary }]}>
            ...
            <View style={{ backgroundColor: Colors.white, flex: 1 }}>
                ...
                <View style={styles.tabContainer}>
                    ...
                    >
                        <Text style={[, styles.tabButtonText, selectedTab === 1 && styles.selectedTabButton,]}>About Blog</Text>
                    </TouchableOpacity>
                    ...
                    >
                        <Text style={[styles.tabButtonText, selectedTab === 2 && styles.selectedTabButton,]}>Comments</Text>
                    </TouchableOpacity>
...
export default YourBlogDetails;